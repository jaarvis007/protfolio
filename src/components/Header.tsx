      ...
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xl font-bold text-green-400 font-mono">~/aman-jain</span>
          </div>
          ...
          <nav className="hidden md:flex items-center space-x-8">
            {navItems.map((item) => (
              <a
                key={item.name}
                href={item.href}
                className="text-green-300 hover:text-green-400 transition-colors duration-300 relative group font-mono"
              >
                {item.name}
        ...
        {/* Mobile Navigation */}
        {isMenuOpen && (
          <nav className="md:hidden mt-4 py-4 border-t border-green-500/30">
            {navItems.map((item) => (
              <a
                key={item.name}
                href={item.href}
